...
public class HazzaTeleporter extends Teleporter
{
...
public HazzaTeleporter(WorldServer par1WorldServer)
{
...
this.field_85192_a.setBlockWithNotify(var17, var18, var19, var20 ? HazzaMod.MysteriousRock.blockID : 0);
}
}
}
...
{
if (this.field_85192_a.getBlockId(var48, var26, var23) == HazzaMod.HazzaPortal.blockID)
{
while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == HazzaMod.HazzaPortal.blockID)
{
--var26;
}
...
if (this.field_85192_a.getBlockId(var12 - 1, var13, var14) == HazzaMod.HazzaPortal.blockID)
{
var50 = 2;
}
...
if (this.field_85192_a.getBlockId(var12, var13, var14 - 1) == HazzaMod.HazzaPortal.blockID)
{
var50 = 3;
}
...
var33 = var21 < 0;
this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? HazzaMod.MysteriousRock.blockID: 0);
}
}
}
}
...
this.field_85192_a.setBlockWithNotify(var22, var23, var24, var33 ? HazzaMod.MysteriousRock.blockID : HazzaMod.HazzaPortal.blockID);
}
}
