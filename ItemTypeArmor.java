...
public class ItemTypeArmor extends ItemArmor implements IArmorTextureProvider
{
    ...
    public ItemTypeArmor(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
    {
 ...
 if(stack.itemID == HazzaMod.DragonScaleHelmet.shiftedIndex || stack.itemID == HazzaMod.DragonScaleChestplate.shiftedIndex || stack.itemID == HazzaMod.DragonScaleLeggings.shiftedIndex)
 {
 return "/Hazza/Armor/scalearmor_1.png";
 }




 if(stack.itemID == HazzaMod.TazniteHelmet.shiftedIndex || stack.itemID == HazzaMod.TazniteChestplate.shiftedIndex || stack.itemID == HazzaMod.TazniteLeggings.shiftedIndex)
 {
 return "/Hazza/Armor/taznitearmor_1.png";
 }


 if(stack.itemID == HazzaMod.DragonScaleBoots.shiftedIndex)
 {
 return "/Hazza/Armor/scalearmor_2.png";
 }



 if(stack.itemID == HazzaMod.TazniteBoots.shiftedIndex)
 {
 return "/Hazza/Armor/taznitearmor_2.png";
 }
 	return null;
 }
