...
public class EntityHostileVillager extends EntityMob
{
    /**
    ...
    public EntityHostileVillager(World par1World)
    {
        super(par1World);
        this.texture = "/Hazza/Mobs/HostileVillager.png";
    ...
    public void onKillEntity(EntityLiving par1EntityLiving)
    {
        ...
        if (this.worldObj.difficultySetting >= 2 && par1EntityLiving instanceof EntityVillager)
        {
            ...
            EntityHostileVillager var2 = new EntityHostileVillager(this.worldObj);
