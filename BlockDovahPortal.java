...
public class BlockDovahPortal extends BlockBreakable
{
    public BlockDovahPortal(int par1, int par2)
    {
    ...
    public static boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.getBlockId(par2 - 1, par3, par4) == HazzaMod.MysteriousRock.blockID || par1World.getBlockId(par2 + 1, par3, par4) == HazzaMod.MysteriousRock.blockID )
        {
            var5 = 1;
        }

        if (par1World.getBlockId(par2, par3, par4 - 1) == HazzaMod.MysteriousRock.blockID  || par1World.getBlockId(par2, par3, par4 + 1) == HazzaMod.MysteriousRock.blockID )
        {
            var6 = 1;
        }
        ...
        else
        {
            ...
            for (var7 = -1; var7 <= 2; ++var7)
            {
                for (var8 = -1; var8 <= 3; ++var8)
                {
                    ...
                    if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3)
                    {
                        ...
                        if (var9)
                        {
                            if (var10 != HazzaMod.MysteriousRock.blockID )
                            {
                                return false;
                            }
                        }
                        else if (var10 != 0 && var10 != HazzaMod.HazzaFire.blockID)
                        {
                            return false;
                        }
                    }
            ...
            for (var7 = 0; var7 < 2; ++var7)
            {
                ...
                {
                    par1World.setBlockWithNotify(par2 + var5 * var7, par3 + var8, par4 + var6 * var7, HazzaMod.HazzaPortal.blockID);
                }
            }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (par1World.getBlockId(par2, var8 - 1, par4) != HazzaMod.MysteriousRock.blockID )
        {
        ...
        else
        {
            ...
            if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == HazzaMod.MysteriousRock.blockID )
            {
                ...
                {
                    if ((par1World.getBlockId(par2 + var6, par3, par4 + var7) != HazzaMod.MysteriousRock.blockID  || par1World.getBlockId(par2 - var6, par3, par4 - var7) != this.blockID) && (par1World.getBlockId(par2 - var6, par3, par4 - var7) != HazzaMod.MysteriousRock.blockID  || par1World.getBlockId(par2 + var6, par3, par4 + var7) != this.blockID))
                    {
                        par1World.setBlockWithNotify(par2, par3, par4, 0);
                    }
                }
    ...
    public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity)
    {
                ...
                if (entity.ridingEntity == null && entity.riddenByEntity == null && entity instanceof EntityPlayerMP)
                {
                        if (entity instanceof EntityPlayerMP)
                        {
                                ...
                                if (entity.dimension != 22)
                                {
                                        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 2 , new HazzaTeleporter(thePlayer.mcServer.worldServerForDimension(2)));
                                }
                                else
                                {
                                        thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new HazzaTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
                                }
                        }
                }
