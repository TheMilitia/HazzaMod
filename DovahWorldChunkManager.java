...
public class DovahWorldChunkManager extends WorldChunkManager
{
    ...
    public DovahWorldChunkManager(BiomeGenBase dovahbiome, float par2, float par3)
    {
        this.biomeGenerator = dovahbiome;
