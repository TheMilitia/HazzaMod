...
public class ItemTypePickaxe extends ItemTool
{
    /** an array of the blocks this pickaxe is effective against */
    public static final Block[] blocksEffectiveAgainst = new Block[] {HazzaMod.MysteriousRock,HazzaMod.TazniteBlock,HazzaMod.TazniteSpawner,HazzaMod.TazmiteOre,HazzaMod.HellStoneBlock,HazzaMod.Cloud,HazzaMod.ChestOfAlexander,HazzaMod.AncientBricks,Block.cobblestone, Block.stoneDoubleSlab, Block.stoneSingleSlab, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.oreIron, Block.blockSteel, Block.oreCoal, Block.blockGold, Block.oreGold, Block.oreDiamond, Block.blockDiamond, Block.ice, Block.netherrack, Block.oreLapis, Block.blockLapis, Block.oreRedstone, Block.oreRedstoneGlowing, Block.rail, Block.railDetector, Block.railPowered};

    public ItemTypePickaxe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
