...
public class BlockDelphiLeaves extends BlockLeavesBase
{
    ...
    protected BlockDelphiLeaves(int i, int j)
    {
   ...
   /* public int colorMultiplier(IBlockAccess iblockaccess, int i, int j, int k)
            ...
            for(int j1 = -l; j1 <= l; j1++)
            {
                for(int k1 = -l; k1 <= l; k1++)
                {
                    for(int l1 = -l; l1 <= l; l1++)
                    {
                        ...
                        if(i2 == HazzaMod.DelphiSapling.blockID)              ///////Leaf/////////////
                        {
                ...
                for(int l1 = -byte0; l1 <= byte0; l1++)
                {
                    for(int k2 = -byte0; k2 <= byte0; k2++)
                    {
                        for(int i3 = -byte0; i3 <= byte0; i3++)
                        {
                            ...
                            if(k3 == HazzaMod.DelphiLog.blockID)            ///////Log//////////////
                            {
                                adjacentTreeBlocks[(l1 + k1) * j1 + (k2 + k1) * byte1 + (i3 + k1)] = 0;
                                continue;
                            }
                            if(k3 == HazzaMod.DelphiLeaves.blockID)               ///////Leaf///////////
                            {
    ...
    {
        return HazzaMod.DelphiSapling.blockID;
    }
