...
public class DovahCaveGen extends MapGenBase
{
    /**
                                ...
                                if (var59 * var59 + var46 * var46 < 1.0D)
                                {
                                    for (int var50 = var38 - 1; var50 >= var57; --var50)
                                    {
                                        ...
                                        if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                        {
                                            ...
                                            if ((byte)var53 == HazzaMod.PrometheusGrass.blockID)
                                            {
                                                var49 = true;
                                            }

                                            if (var53 == (byte)HazzaMod.HellStoneBlock.blockID || var53 == (byte)HazzaMod.AresDirt.blockID || var53 == (byte)HazzaMod.PrometheusGrass.blockID)
                                            {
                                                if (var50 < 10)
                                                {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (var49 && par5ArrayOfByte[var48 - 1] == HazzaMod.AresDirt.blockID)
                                                    {
